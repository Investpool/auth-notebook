            ...
            <div>
                ...
                <div className = 'note-container'>
                    ...
                    <form className ='form'>
                        ...
                        <h4>Title</h4>
                        <input type ='text' name='title' placeholder ='Enter Note Title' value={ this.state.title }
                        onChange= {this.handleOnChange}></input>
                        <br></br>

                            <h4>Notes</h4>
                        <textarea rows = "5" col='100' name='notes' placeholder ='Enter Notes' value={ this.state.notes } 
                        onChange= {this.handleOnChange}></textarea>
                        <br></br>

                        <button type='button' className="btn btn-primary submit" onClick= { this.handleSubmit }>Submit</button>
                    </form>
                </div>
